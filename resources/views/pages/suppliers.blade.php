...
<div id="supplierDetailOverlay"
    ...
    <div style="background:var(--bg-card, #fff); border-radius:12px; width:100%; max-width:440px; padding:24px; box-shadow:0 10px 40px rgba(0,0,0,0.25); max-height:85vh; overflow-y:auto">
        ...
        <div style="display:flex; justify-content:flex-end; gap:8px; margin-top:20px">
            <a id="sd-wa-btn" href="#" target="_blank" class="btn btn--primary" style="display:none; background-color:#25D366; border-color:#25D366">
...
<script>
    function openSupplierDetail(id) {
        ...
        document.getElementById('sd-phone').textContent    = phone;
        ...
        if (phone && phone !== '—') {
            ...
            if (cleanPhone.length > 8) { // minimal validasi dasar
